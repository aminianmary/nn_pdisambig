...
if __name__ == '__main__':
    ...
    parser.add_option("--d_cw", type="int", dest="d_cw", help="character lstm dimension for lemma", default=200)
    ...
    parser.add_option("--lem_char_k", type="int", dest="lem_char_k", default=2)
